...
- "titles": JSON array of 5 SEO-optimized YouTube titles in English (include lofi keyword, end with emojis)
...
_BASE_CSS = (
    ...
    ".ttxt-wrap { flex: 1; } .ttxt { font-size: 15px; font-weight: 500; color: rgba(255,255,255,0.88); line-height: 1.5; }"
...
def _titles_sec(titles_en: list, titles_zh: list) -> str:
    ...
    return (
        ...
        f'<div class="lbl" style="margin:0;">🏆 High-Click Titles</div>'
        f'<button class="trans-btn" onclick="toggleLang(this)">🌐 中文</button>'
        f'</div>'
        f'{rows}</div>'
    )
